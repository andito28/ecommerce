...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('material/global/vendor/waves/waves.css')}}">
        ...
        <link rel="stylesheet" href="{{asset('material/assets/examples/css/dashboard/v1.css')}}">
    ...
    <link rel='stylesheet' href='{{asset('material/')}}http://fonts.googleapis.com/css?family=Roboto:300,400,500,300italic'>
                      ...
                      <ul class="blocks-3">
                        <li>
                          <a class="thumbnail m-0" href="javascript:void(0)">
                            <img class="w-full" src="{{asset('material/global/photos/placeholder.png')}}" alt="..." />
                          </a>
                        </li>
                        <li>
                          <a class="thumbnail m-0" href="javascript:void(0)">
          ...
          <div class="col-xl-4 col-lg-6">
            ...
            <div class="card" id="widgetUserList">
              <div class="card-header cover overlay">
                <img class="cover-image h-200" src="{{asset('material/assets/examples/images/dashboard-header.jpg')}}"
                  alt="..." />
                ...
                <ul class="list-group list-group-full list-group-dividered mb-0">
                    ...
                    <div class="media">
                      <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                          <img class="img-fluid" src="{{asset('material/global/portraits/1.jpg')}}"
                            alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                          <img class="img-fluid" src="{{asset('material/global/portraits/2.jpg')}}"
                            alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                          <img class="img-fluid" src="{{asset('material/global/portraits/3.jpg')}}"
                            alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                  ...
                  <div class="chat chat-left">
                    <div class="chat-avatar">
                      <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="">
                        <img src="{{asset('material/global/portraits/5.jpg')}}" alt="Edward Fletcher">
                      </a>
                    </div>
                    <div class="chat-body">
                  ...
                  <div class="chat">
                    <div class="chat-avatar">
                      <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="">
                        <img src="{{asset('material/global/portraits/4.jpg')}}" alt="June Lane">
                      </a>
                    </div>
                    <div class="chat-body">
